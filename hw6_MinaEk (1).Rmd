...
setwd('/Users/minaekramnia/Downloads/open_data_year_one')
`files_in_year_one`<- list.files() 
'character vector with three entries' <- c(files_in_year_one[1],files_in_year_one[3])
...
`data_list` <- read_csv(`character vector with three entries`)
...
`data_list_names`<-`data_list[["station_data"]]`
